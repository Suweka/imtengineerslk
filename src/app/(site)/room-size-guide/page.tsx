...
export default async function RoomSizeGuidePage() {
  const content = await getPageContent("room-size-guide");
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      ...
      <p className="mt-4 max-w-2xl text-sm text-slate-600">{content.body}</p>
